...
class TestDeepRails:
    ...
    def test_hardcoded_query_params_in_url(self, client: DeepRails) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: DeepRails) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: DeepRails) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: DeepRails) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.defend.with_streaming_response.create_workflow(
                improvement_action="regen", name="name", threshold_type="automatic"
            ).__enter__()
...
class TestAsyncDeepRails:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncDeepRails) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncDeepRails) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
